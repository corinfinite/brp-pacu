...
pkgdatadir = $(datadir)/BRP_PACU
pkglibdir = $(libdir)/BRP_PACU
pkgincludedir = $(includedir)/BRP_PACU
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
bin_PROGRAMS = BRP_PACU$(EXEEXT)
#########  Macintosh implementation #########
#am__append_1 = ige-mac-menu.c ige-mac-dock.c
#am__append_2 = 
#am__append_3 = -xobjective-c -framework Carbon -lobjc
...
am__BRP_PACU_SOURCES_DIST = testfft.c gui.c BRP_PACU.c ige-mac-menu.c \
	ige-mac-dock.c
#am__objects_1 = ige-mac-menu.$(OBJEXT) \
#	ige-mac-dock.$(OBJEXT)
am_BRP_PACU_OBJECTS = testfft.$(OBJEXT) gui.$(OBJEXT) \
	BRP_PACU.$(OBJEXT) $(am__objects_1)
BRP_PACU_OBJECTS = $(am_BRP_PACU_OBJECTS)
BRP_PACU_LDADD = $(LDADD)
DEFAULT_INCLUDES = -I.
...
CCLD = $(CC)
SOURCES = $(BRP_PACU_SOURCES)
DIST_SOURCES = $(am__BRP_PACU_SOURCES_DIST)
...
ACLOCAL = ${SHELL} /home/brphelps/BRP-PACU-Staging/git_tree/brp-pacu/missing --run aclocal-1.10
AMTAR = ${SHELL} /home/brphelps/BRP-PACU-Staging/git_tree/brp-pacu/missing --run tar
AUTOCONF = ${SHELL} /home/brphelps/BRP-PACU-Staging/git_tree/brp-pacu/missing --run autoconf
AUTOHEADER = ${SHELL} /home/brphelps/BRP-PACU-Staging/git_tree/brp-pacu/missing --run autoheader
AUTOMAKE = ${SHELL} /home/brphelps/BRP-PACU-Staging/git_tree/brp-pacu/missing --run automake-1.10
AWK = gawk
...
GDK_LIBS = @GDK_LIBS@
GTKDATABOX_CFLAGS = @GTKDATABOX_CFLAGS@
GTKDATABOX_LIBS = @GTKDATABOX_LIBS@
...
LIBOBJS = 
LIBS = -lm -lpthread  -lfftw  `pkg-config --libs  libglade-2.0`  `pkg-config --libs  gtk+-2.0` `pkg-config --libs  gdk`  `pkg-config --libs gtkdatabox` `pkg-config --libs jack`
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/brphelps/BRP-PACU-Staging/git_tree/brp-pacu/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = BRP_PACU
PACKAGE_BUGREPORT = 
...
PKG_CONFIG_PATH =  $(am__append_2)
SET_MAKE = 
SHELL = /bin/bash
STRIP = 
VERSION = 2.0.7
abs_builddir = /home/brphelps/BRP-PACU-Staging/git_tree/brp-pacu
abs_srcdir = /home/brphelps/BRP-PACU-Staging/git_tree/brp-pacu
abs_top_builddir = /home/brphelps/BRP-PACU-Staging/git_tree/brp-pacu
abs_top_srcdir = /home/brphelps/BRP-PACU-Staging/git_tree/brp-pacu
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = $(SHELL) /home/brphelps/BRP-PACU-Staging/git_tree/brp-pacu/install-sh
...
BRP_PACU_SOURCES = testfft.c gui.c BRP_PACU.c $(am__append_1)
...
AM_CFLAGS = -O2 -Wall -g `pkg-config --cflags libglade-2.0` \
	`pkg-config --cflags gtk+-2.0` `pkg-config --cflags gdk` \
	`pkg-config --cflags gdk-2.0` `pkg-config --cflags gtkdatabox` \
	-DDATADIR=\"$(datadir)\" $(am__append_3)
...
BRP_PACU$(EXEEXT): $(BRP_PACU_OBJECTS) $(BRP_PACU_DEPENDENCIES) 
	@rm -f BRP_PACU$(EXEEXT)
	$(LINK) $(BRP_PACU_OBJECTS) $(BRP_PACU_LDADD) $(LIBS)
...
include ./$(DEPDIR)/BRP_PACU.Po
include ./$(DEPDIR)/gui.Po
include ./$(DEPDIR)/ige-mac-dock.Po
include ./$(DEPDIR)/ige-mac-menu.Po
include ./$(DEPDIR)/testfft.Po
...
installdirs:
	for dir in "$(DESTDIR)$(bindir)" "$(DESTDIR)$(pkgdatadir)" "$(DESTDIR)$(includedir)"; do \
...
#	cp -fp AUTHORS COPYING COPYING.LESSER NEWS ChangeLog README-Mac.txt macdistdir
